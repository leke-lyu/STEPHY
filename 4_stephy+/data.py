#!/usr/bin/env python3
"""
Data Loading and Preprocessing for STEPHY+ (Phylogeny + Epidemiological Data).

Loads phylogenetic trees (*_beast2.trees) and epi features (*_nf.csv) to build DGL graphs.
"""
...
#
# Encodes tree topology as a (subtree_width × 4) matrix per location via
