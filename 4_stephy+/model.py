#!/usr/bin/env python3
"""
STEPHY+ Model: CBLV-GAT with Phylogeny + Epidemiological Features.

Combines phylogenetic (CBLV encoder) and epidemiological features with GAT for spatial aggregation.
"""
