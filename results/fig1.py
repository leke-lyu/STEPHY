#!/usr/bin/env python3
"""
Figure 1 — Model diagnostics (2-row, 4-column layout).
...
Usage:
    python3 fig1.py
    python3 fig1.py --base_dir /path/to/results
"""
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'fig1.pdf')
